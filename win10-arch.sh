...
echo "==================================================================="
echo "Starting Windows 10 VM setup script for Arch Linux..."
echo "Bắt đầu tập lệnh cài đặt máy ảo Windows 10 cho Arch Linux..."
echo "==================================================================="
echo ""
...
# Install docker and docker-compose. Docker will handle its containerd dependency.
...
# Enable and start the main Docker service.
...
echo "==================================================================="
echo "Setup complete for Arch Linux!"
echo "Thiết lập đã hoàn tất cho Arch Linux!"
echo ""
